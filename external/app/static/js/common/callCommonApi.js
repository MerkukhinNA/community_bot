...
export function getUserEvents(localPath='') {
    ...
    const api = localPath + 'api/v1/users/events'
    console.log(`Отправленные данные на "${api}":`, data);
    return fetch(api, {
        method: 'POST',
        headers: {
...
export function getUserFeedbacks(localPath='') {
    const data = {
        chat_id: String(getUserId()),
    }
    
    const api = localPath + 'api/v1/users/feedbacks'
    console.log(`Отправленные данные на "${api}":`, data);
    return fetch(api, {
        method: 'POST',
        headers: {
...
export function getQuestions(localPath='') {
    ...
    const api = localPath + 'api/v1/feedback'
    console.log(`Отправленные данные на "${api}":`, data);
    return fetch(api, {
        method: 'POST',
        headers: {
